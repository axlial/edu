...
Задание 12.3 ftp-сервер и пользователь ## ПЕРЕПИСАТЬ ПЛЕЙБУК
Для выполнения задания воспользуйтесь пакетом vsftpd.
yum install vsftpd
systemctl start vsftpd
useradd test_ftp
passwd test_ftp

Задание 12.4 Удаление ftp-сервера
Для выполнения задания удалите пакет vsftpd.
...
Отдельные замечания - на вкладке курс Linux не все пройденные задания отмечаются галочкой, вот список из них:
Тема 1. Основные принципы администрирования систем, настройка системы, файловая система
Задание 3.3 Создание директории
Тема 4. Права доступа к файлам. Пользователи и группы.
Задание 8.7 Работа с файлами в архивах
Задание 10.1 Cron-задание
Задание 11.5 Названия интерфейсов
Задание 13.1 Основные записи домена


Задание 6.1 Не работает phpinfo.php - задание отсуствует.
